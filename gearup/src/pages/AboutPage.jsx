        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex justify-center">
              <Link 
                to="/services" 
                className="bg-white text-blue-700 dark:bg-gray-800 dark:text-white font-medium rounded-lg px-6 py-3 mr-4 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors"
              >
                Our Services
              </Link>
              <Link 
                to="/contact" 
                className="bg-transparent border-2 border-white text-white font-medium rounded-lg px-6 py-3 hover:bg-white hover:text-blue-700 dark:hover:bg-gray-800 dark:hover:text-white transition-colors"
              >
                Contact Us
              </Link>
            </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 md:px-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12 dark:text-white">Our Mission</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white dark:bg-gray-700 rounded-xl shadow p-6 text-center">
              <div className="bg-blue-100 dark:bg-blue-900 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <UserIcon className="h-8 w-8 text-blue-700 dark:text-blue-300" />
              </div>
              <h3 className="text-xl font-bold mb-3 dark:text-white">Customer First</h3>
            ...
            <div className="bg-white dark:bg-gray-700 rounded-xl shadow p-6 text-center">
              <div className="bg-blue-100 dark:bg-blue-900 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <WrenchIcon className="h-8 w-8 text-blue-700 dark:text-blue-300" />
              </div>
              <h3 className="text-xl font-bold mb-3 dark:text-white">Quality Service</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-700 rounded-xl shadow p-6 text-center">
              <div className="bg-blue-100 dark:bg-blue-900 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <StarIcon className="h-8 w-8 text-blue-700 dark:text-blue-300" />
              </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <div key={index} className="bg-white dark:bg-gray-700 rounded-xl shadow p-6 text-center">
                <img 
                  src={member.image} 
                  alt={member.name}
                ...
                <p className="text-blue-700 dark:text-blue-300 font-medium mb-3">{member.role}</p>
      ...
      <section className="bg-blue-700 dark:bg-blue-800 text-white py-16">
        <div className="container mx-auto px-4 md:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link 
              to="/register" 
              className="bg-white text-blue-700 dark:bg-gray-800 dark:text-white font-medium rounded-lg px-6 py-3 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors"
            >
              Sign Up Now
            </Link>
            <Link 
