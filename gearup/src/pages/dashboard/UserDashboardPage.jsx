  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        const bookingsResponse = await api.get("http://localhost:3000/api/v1/bookings", {
          params: {
            limit: 5,
            sort: "-created_at",
          },
        ...
        // Fetch notifications
        const notificationsResponse = await api.get("http://localhost:3000/api/v1/users/notifications")
